...
-- -----------------------------------------------------
START TRANSACTION;
INSERT INTO `user` (`uuid`, `_revision`, `display_name`, `added`, `last_login`) VALUES (0xD6FCB336EE52416D9AA04A0F7D59612C, DEFAULT, 'Super Admin', 'NOW()', NULL);
