...
CREATE TABLE IF NOT EXISTS `webauthn` (
  ...
  `allow_cloning` CHAR(1) NOT NULL DEFAULT 'F',
...
CREATE TABLE IF NOT EXISTS `password` (
  ...
  `requires_2fa` CHAR(1) NOT NULL DEFAULT 'T',
  `added` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP(),
  `used` DATETIME NULL DEFAULT NULL,
  PRIMARY KEY (`uuid`),
...
-- -----------------------------------------------------
START TRANSACTION;
INSERT INTO `password` (`uuid`, `user_uuid`, `algorithm`, `password`, `requires_2fa`, `added`, `used`) VALUES (0x3B2D4234E81448F0808BBBBF9B7BF5AB, 0xD6FCB336EE52416D9AA04A0F7D59612C, 'Argon2', '$argon2id$v=19$m=4096,t=192,p=16$c2FsdHNhbHRzYWx0$tz06nxFEeiD7jm+po95x67Ky2K/4BstPcy+7flDnKt0', 'F', DEFAULT, NULL);
